...
void shingle_stream(shingle_t s, int (*getch)(void *), void *f,
		fprint_t minima[]);
...
void shingle_megashingle(shingle_t s, fprint_t supershingles[],
		unsigned nsupershingles, fprint_t megashingles[], unsigned choose);
